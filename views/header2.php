      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li><a href="newsactions"><span class="glyphicon glyphicon-envelope"></span> News</a></li>
            <li><a href="staffactions"><span class="glyphicon glyphicon-user"></span> Staff</a></li>
          </ul>
        </div>
      </div>
    </nav>
